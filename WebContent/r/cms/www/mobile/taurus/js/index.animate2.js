(function ($) {
    ...
    $.extend(Mgm.prototype, {
        ...
        init: function(data) {
			...
			$('.ploading').show()
				this.loadimages(['music/bg.mp3','music/fdj.mp3','music/sync.mp3','images/fordlogo.png','images/door.jpg','images/change.jpg','images/part/0.jpg','images/part/1.png','images/part/2.png','images/part/3.png',
				'images/part/4.png','images/part/5.png','images/part/6.png','images/part/7.png','images/part/bg.jpg','images/part/line.png','images/part/line3.png',
				'images/part/line2.png','images/car/1.png','images/car/2.png','images/car/3.png','images/car/4.png','images/car/5.png','images/car/6.png','images/car/7.png',
				'images/car/8.png','images/car/icon_1.png','images/car/icon_2.png','images/car/icon_3.png','images/car/icon_4.png','images/car/icon_5.png','images/car/icon_6.png',
				'images/car/icon_7.png','images/car/icon_8.png','images/sharetips.png','images/icon/clock.png','images/icon/clockon.png','images/icon/icon_car1.png','images/icon/icon_car2.png',
				'images/icon/icon_car3.png','images/icon/icon_car4.png','images/icon/icon_car5.png','images/icon/icon_car6.png','images/icon/icon_car7.png','images/icon/icon_car8.png',
				'images/icon/icon_car1_on.png','images/icon/icon_car2_on.png','images/icon/icon_car3_on.png','images/icon/icon_car4_on.png','images/icon/icon_car5_on.png','images/icon/icon_car6_on.png',
				'images/icon/icon_car7_on.png','images/icon/icon_car8_on.png','images/icon/icondate.png','images/icon/shareicon.png','images/part/cart3on.png'])
        },
		...
		landing:function(){
			...
			console.log(urlinfo);
			if (urlinfo.indexOf("nickName")>=0) {
				var nickname = location.search.match(new RegExp("[\?\&]nickName=([^\&]+)", "i"))[1];
			  	var photo = location.search.match(new RegExp("[\?\&]userPhoto=([^\&]+)", "i"))[1];
			 	$('.userImg').attr('src','http://yiche.changanfordwechat.com/common/image/scaling.htm?url='+decodeURI(photo).replace(/\\/g,'')+'&width=70&height=70');
		...
		chooseRight:function(id){
			...
			if (id===7) {
				...
				$(".part7 section").css("top","-480px");
				$(".part7 section").css("left","393px");
				$('.part'+id+' .line').show();
				$('.part'+id+' .line').css("top","-210px");
				$('.part'+id+' .ppz').css("opacity","1");

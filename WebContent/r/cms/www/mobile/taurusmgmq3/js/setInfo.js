...
var chann = urlRequest("channel");
	...
	$(".owner").on("touchstart",function(){
		if (window.tabOwner == true) {
			...
			$(".owner>img").attr("src","/r/cms/www/mobile/taurusmgmq3/img/owerACT.png?1212");
			$(".notowner>img").attr("src","/r/cms/www/mobile/taurusmgmq3/img/notOwner.png?1212");
			$(".ownerForm").show();
			$(".newbieForm").hide();
			window.tabOwner = true;
		}
	...
	$(".notowner").on("touchstart",function(){
		if (window.tabOwner == false) {
			...
			$(".owner>img").attr("src","/r/cms/www/mobile/taurusmgmq3/img/owner.png?1212");
			$(".notowner>img").attr("src","/r/cms/www/mobile/taurusmgmq3/img/notOwnerACT.png?1212");
			$(".ownerForm").hide();
			$(".newbieForm").show();
	...
	$("#chk01").click(function(){
		if (window.agreeNotice) {
			...
			$("#chk01").attr('src','/r/cms/www/mobile/taurusmgmq3/img/checkbox.png');
		} else {
			window.agreeNotice = true;
			$("#chk01").attr('src','/r/cms/www/mobile/taurusmgmq3/img/checked.png');
		}
	})
	...
	$("#chk02").click(function(){
		if (window.agreeNotice2) {
			...
			$("#chk02").attr('src','/r/cms/www/mobile/taurusmgmq3/img/checkbox.png');
		} else {
			window.agreeNotice2 = true;
			$("#chk02").attr('src','/r/cms/www/mobile/taurusmgmq3/img/checked.png');
		}
	})

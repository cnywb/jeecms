$(function () {
	...
	$("#chk01").click(function(){
		if (window.agreeNotice) {
			...
			$("#chk01").attr('src','/r/cms/www/mobile/edgeMGM_old/new/n-ck2.png');
		} else {
			window.agreeNotice = true;
			$("#chk01").attr('src','/r/cms/www/mobile/edgeMGM_old/new/n-ck1.png');
		}
	})
	...
	$.ajax({  
		...
		data:{
			...
			'infoList[0].activityName':'锐界新车主推荐活动',
                        'infoList[0].wechatId':urlRequest('openId'),

...
utm_source = urlRequest("utm_source");
utm_medium = urlRequest("utm_medium");
utm_content = urlRequest("utm_content");
utm_campaign = urlRequest("utm_campaign");
channel = urlRequest("channel");

shareLink = "http://www.changanfordwechat.com/fordwechat/control?state=16101&utm_source=" + utm_source + "&utm_medium=" + utm_medium + "&utm_content=" + utm_content + "&utm_campaign=" + utm_campaign + "&channel=" + channel;
...
//}  
	...
	window.share = {
		imgUrl : 'http://www.changanfordclub.com/r/cms/www/mobile/csl/assets/i/shareImg.jpg',
		link : shareLink,
		title : "超级[福]利,只为热爱足球的你",
		desc : "万张球票，邀你玩转中超。",
		}
		shareConfig();
	});

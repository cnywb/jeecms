...
var chann = urlRequest("channel");
	...
	$(".owner").on("touchstart",function(){
		if (window.tabOwner == true) {
			...
			$(".owner>img").attr("src","/r/cms/www/mobile/taurusmgmq2/assets/i/owerACT.png?1212");
			$(".notowner>img").attr("src","/r/cms/www/mobile/taurusmgmq2/assets/i/notOwner.png?1212");
			$(".ownerForm").show();
			$(".newbieForm").hide();
			window.tabOwner = true;
		}
	...
	$(".notowner").on("touchstart",function(){
		if (window.tabOwner == false) {
			...
			$(".owner>img").attr("src","/r/cms/www/mobile/taurusmgmq2/assets/i/owner.png?1212");
			$(".notowner>img").attr("src","/r/cms/www/mobile/taurusmgmq2/assets/i/notOwnerACT.png?1212");
			$(".ownerForm").hide();
			$(".newbieForm").show();
	...
	$("#chk01").click(function(){
		if (window.agreeNotice) {
			...
			$("#chk01").attr('src','/r/cms/www/mobile/taurusmgmq2/assets/i/checkbox.png');
		} else {
			window.agreeNotice = true;
			$("#chk01").attr('src','/r/cms/www/mobile/taurusmgmq2/assets/i/checked.png');
		}
	})
	...
	$("#chk02").click(function(){
		if (window.agreeNotice2) {
			...
			$("#chk02").attr('src','/r/cms/www/mobile/taurusmgmq2/assets/i/checkbox.png');
		} else {
			window.agreeNotice2 = true;
			$("#chk02").attr('src','/r/cms/www/mobile/taurusmgmq2/assets/i/checked.png');
		}
	})
...
function saveinfor(name,mobile,nameSugg,mobileSugg,owerCar,prov,city,dealer,buytime,channel){
	...
	$.ajax({  
		...
		data:{
			...
			'infoList[0].activityName':'金牛座新车主推荐活动',
...
'infoList[0].carOwnerMobilePhoneNo':mobile,
			...
			'infoList[0].intentionalCarModel':'金牛座',
			'infoList[0].activityName':'金牛座老车主再购活动',
			'infoList[0].channel':channel
		},
		type: 'post',
		cache: false,

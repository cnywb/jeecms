...
for (var i=0;i<121;i++) {
				$(".imgGroup").append("<img src='/r/cms/www/mobile/fordSug2/assets/i/h1/" + i + ".png'/>");
				$(".imgGroup").append("<img src='/r/cms/www/mobile/fordSug2/assets/i/h2/" + i + ".png'/>");
				$(".imgGroup").append("<img src='/r/cms/www/mobile/fordSug2/assets/i/h3/" + i + ".png'/>");
			}

...
//}  
	...
	window.share = {
		imgUrl : 'http://yiche.changanfordwechat.com/r/cms/www/mobile/yiboBoss/images/shareimg.jpg',
		link : 'http://yiche.changanfordwechat.com',
		title : "在小搏的助力下，TA通过【学会独立，努力进取】赢得老板的青睐，赢遍办公室无敌手！！",
		desc : "想知道你搞定老板的独门秘籍吗？戳这里，戳这里，戳这里！重要的事说三遍！",
		}
		shareConfig();
	});
	...
	function shareConfig(){
		...
		$.getJSON("http://test.changanfordwechat.com/getinfo?state=4&url="+ thisurl, function (data) {

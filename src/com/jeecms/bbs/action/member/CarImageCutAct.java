...
@Controller
public class CarImageCutAct {
	private static final Logger log = LoggerFactory
			.getLogger(CarImageCutAct.class);
	/**
	 * 图片选择页面
	 */
	public static final String IMAGE_SELECT_RESULT = "/WEB-INF/t/cms/www/blue/member/car_image_area_select.html";
	/**
	 * 图片裁剪完成页面
	 */
	public static final String IMAGE_CUTED = "/WEB-INF/t/cms/www/blue/member/car_image_cuted.html";
	/**
	 * 错误信息参数
	 */
	public static final String ERROR = "error";

	@RequestMapping("/member/car/v_image_area_select.jhtml")
	...
	@RequestMapping("/member/car/o_image_cut.jhtml")

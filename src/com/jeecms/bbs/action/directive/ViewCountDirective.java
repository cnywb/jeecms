...
public class ViewCountDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		Long viewDayCount = topicCountEhCache.getViewCount(topicId,TopicCountEnum.day);
		Long viewWeekCount = topicCountEhCache.getViewCount(topicId,TopicCountEnum.week);
		Long viewMonthCount = topicCountEhCache.getViewCount(topicId,TopicCountEnum.month);

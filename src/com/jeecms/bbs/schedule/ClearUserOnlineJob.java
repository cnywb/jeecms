...
public class ClearUserOnlineJob {
	...
	public void executeByDay() {
		...
		bbsTopicMng.updateAllTopicCount(TopicCountEnum.day);
	...
	public void executeByWeek() {
		...
		bbsTopicMng.updateAllTopicCount(TopicCountEnum.week);
	...
	public void executeByMonth() {
		...
		bbsTopicMng.updateAllTopicCount(TopicCountEnum.month);

...
public class BbsTopic extends BaseBbsTopic {
	...
	public boolean isNew() {
		long offset=48*60L*60L*1000L;//48小时
		Date currentDate=new Date();
		return (currentDate.getTime()-getCreateTime().getTime())<=offset;
	}
	/**
	 * 是否问题贴
	 * @return
	...
	public boolean isQuestion() {
		return (getTitle().indexOf("？")!=-1||getTitle().indexOf("?")!=-1);
	}
	/**
	 * 是否点击热贴
	 * @return
	 */
	public boolean isViewHot() {
		return getViewCount() >= 10;
	}
}
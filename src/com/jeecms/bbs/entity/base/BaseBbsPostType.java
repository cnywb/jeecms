...
public abstract class BaseBbsPostType  implements Serializable,Comparable {
	...
	// collections
	private java.util.Set<com.jeecms.bbs.entity.BbsPostType> childs=new HashSet<com.jeecms.bbs.entity.BbsPostType>();
	private java.util.Set<com.jeecms.bbs.entity.BbsUserGroup> groups;
	
	private List<com.jeecms.bbs.entity.BbsPostType> childList;

	public List<com.jeecms.bbs.entity.BbsPostType> getChildList() {
		return new ArrayList<com.jeecms.bbs.entity.BbsPostType>(childs);
	}

	public void setChildList(List<com.jeecms.bbs.entity.BbsPostType> childList) {
	...
	public int compareTo(Object o) {
		BaseBbsPostType a=(BaseBbsPostType)o;
		if(this.priority==a.priority){
			return 0;
		}
		  return (this.priority>a.priority?1:-1);
    }

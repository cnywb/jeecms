...
public abstract class BaseBbsTopic  implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4410752877010069045L;
	...
	public static String PROP_IS_FORBID_REPLY = "isForbidReply";
	// constructors
	public BaseBbsTopic () {
		initialize();
	}
	...
	private Boolean isForbidReply=false;

	private  Date voteStartTime;//投票开始时间
	private  Date voteEndTime;//投票结束时间
	private Boolean multipleVote=false;//是否可多选
	private Boolean visibleAfterReply=false;//是否回复后可见
	
	private List<String> firstPostImageSrcList;//首贴图片路径
	

	public List<String> getFirstPostImageSrcList() {
		return firstPostImageSrcList;
	}

	public void setFirstPostImageSrcList(List<String> firstPostImageSrcList) {
		this.firstPostImageSrcList = firstPostImageSrcList;
	}
	...
	public Boolean getVisibleAfterReply() {
		return visibleAfterReply;
	}

	public void setVisibleAfterReply(Boolean visibleAfterReply) {
		this.visibleAfterReply = visibleAfterReply;
	}
	...
	public Boolean getIsForbidReply() {
		return isForbidReply;
	}

	public void setIsForbidReply(Boolean isForbidReply) {
		this.isForbidReply = isForbidReply;
	}

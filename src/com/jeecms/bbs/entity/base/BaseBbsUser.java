...
public abstract class BaseBbsUser implements Serializable {
	...
	private String cmsUserComefrom;//来自
	
	private String cmsUserCarStyle;//爱车
	
	private Long   userCurrentPoint;//兑奖积分
	
	private String nextGroupName="";//下一级别的名称
	
	private long percentToNextGroup=0;//离下一级别的百分比
	...
	public long getPercentToNextGroup() {
		return percentToNextGroup;
	}

	public void setPercentToNextGroup(long percentToNextGroup) {
		this.percentToNextGroup = percentToNextGroup;
	}

	public String getCmsUserComefrom() {
		return cmsUserComefrom;
	}

	public void setCmsUserComefrom(String cmsUserComefrom) {
		this.cmsUserComefrom = cmsUserComefrom;
	}

	public String getCmsUserCarStyle() {
		return cmsUserCarStyle;
	}

	public void setCmsUserCarStyle(String cmsUserCarStyle) {
		this.cmsUserCarStyle = cmsUserCarStyle;
	}
	...
	public Long getUserCurrentPoint() {
		return userCurrentPoint;
	}

	public void setUserCurrentPoint(Long userCurrentPoint) {

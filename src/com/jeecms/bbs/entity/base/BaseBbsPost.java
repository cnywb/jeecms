...
public abstract class BaseBbsPost  implements Serializable {
	...
	private BbsPost replyToBbsPost;//
	...
	public BbsPost getReplyToBbsPost() {
		return replyToBbsPost;
	}

	public void setReplyToBbsPost(BbsPost replyToBbsPost) {
		this.replyToBbsPost = replyToBbsPost;
	}

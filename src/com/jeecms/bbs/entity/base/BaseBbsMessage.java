...
public abstract class BaseBbsMessage  implements Serializable {
	...
	public String getReceiverImgSrc() {
		return receiver.getAvatar();
	}

	public void setReceiverImgSrc(String receiverImgSrc) {
		this.receiverImgSrc = receiverImgSrc;
	}

...
public abstract class BaseBbsForum implements Serializable {
	...
	public static String PRO_IMG_URL = "imgUrl";
	...
	public BaseBbsForum(java.lang.Integer id,
			...
			com.jeecms.cms.entity.main.CmsSite site, java.lang.String path,
			...
			java.lang.Integer pointPrime,java.lang.String imgUrl) {
	...
	public List<BbsPostType> getPostTypeList(){
		List<BbsPostType> postTypesList=new ArrayList<BbsPostType>(10);
		for(BbsPostType t:postTypes){
			postTypesList.add(t);
		}
		 Collections.sort(postTypesList);

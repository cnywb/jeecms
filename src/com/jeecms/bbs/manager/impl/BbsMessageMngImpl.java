...
public class BbsMessageMngImpl implements BbsMessageMng {
	...
	public int  getTotalCountByReceiverAndTypeIdAndStatus(Integer userId, Integer typeId,Boolean status){
		return dao.getTotalCountByReceiverAndTypeIdAndStatus(userId, typeId, status);
	}

	public List<BbsMessage> getListByTypeAndUserId(Integer userId, Integer typeId){
		return dao.getListByTypeAndUserId(userId, typeId);
	}
	public List getListBySenderUserIdStatus(Integer userId, Integer typeId,
			Boolean status) {
		
		return dao.getListBySenderUserIdStatus(userId, typeId, status);
	}
	public Pagination getPageBySenderUserId(Integer userId, Integer typeId,Integer pageNo,
			Integer pageSize){
		return dao.getPageBySenderUserId(userId, typeId, pageNo, pageSize);
	}

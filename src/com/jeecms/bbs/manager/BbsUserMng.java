...
public interface BbsUserMng {
	...
	public BbsUser registerMember(String username, String email,String password, String ip, Integer groupId, BbsUserExt userExt);
	
	public BbsUser registerMember(String username, String email,String password, String ip, Integer groupId, BbsUserExt userExt,Integer unifUserId);
	
	public BbsUser registerMember(String username, String email,
			String password, String ip, Integer groupId, BbsUserExt userExt, Boolean activation , EmailSender sender, MessageTemplate msgTpl) throws UnsupportedEncodingException, MessagingException  ;
	...
	public BbsUser deleteBbsUserById(Integer id);
	
	public BbsUser[] deleteBbsUserByIds(Integer[] ids);
	...
	public void update(BbsUser bbsUser);
}
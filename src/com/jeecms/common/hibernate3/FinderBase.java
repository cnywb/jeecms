...
public class FinderBase {
	...
	protected FinderBase(String hql) {
		hqlBuilder = new StringBuilder(hql);
	}

	public static FinderBase create() {
		return new FinderBase();
	}

	public static FinderBase create(String hql) {
		return new FinderBase(hql);
	}

	public FinderBase append(String hql) {
	 ...
	 */
	public FinderBase setParam(String param, Object value) {
	 ...
	 */
	public FinderBase setParam(String param, Object value, Type type) {
		getParams().add(param);
		getValues().add(value);
		getTypes().add(type);
		return this;
	 ...
	 */
	public FinderBase setParams(Map<String, Object> paramMap) {
	 ...
	 */
	public FinderBase setParamList(String name, Collection<Object> vals, Type type) {
	 ...
	 */
	public FinderBase setParamList(String name, Collection<Object> vals) {
	 ...
	 */
	public FinderBase setParamList(String name, Object[] vals, Type type) {
	 ...
	 */
	public FinderBase setParamList(String name, Object[] vals) {
		return setParamList(name, vals, null);
	}
	...
	private String getRowCountBaseHql(String indexKey) {
		...
		return wrapProjectionByBean(projectionHql) + rowCountHql;
	}
	...
	private String wrapProjectionByBean(String projection) {
		if (projection.indexOf("select") == -1) {
			return ROW_COUNT;
		} else {
			return projection.replace(projection, " select count(bean) ");
		}
	}

...
public abstract class BaseCmsUser  implements Serializable {
    ...
    private Long registType=1L;//注册类型
	...
	private com.jeecms.cms.entity.main.CmsDepartment department;
	...
	private java.util.Set<com.jeecms.cms.entity.main.CmsWorkflowEventUser> eventUsers;
	private java.util.Set<com.jeecms.cms.entity.main.CmsWorkflowRecord> checkRecords;
	...
	public com.jeecms.cms.entity.main.CmsDepartment getDepartment() {
		return department;
	}

	public void setDepartment(com.jeecms.cms.entity.main.CmsDepartment department) {
	...
	public java.util.Set<com.jeecms.cms.entity.main.CmsWorkflowEventUser> getEventUsers() {
		return eventUsers;
	}

	public void setEventUsers(
			java.util.Set<com.jeecms.cms.entity.main.CmsWorkflowEventUser> eventUsers) {
		this.eventUsers = eventUsers;
	}

	public java.util.Set<com.jeecms.cms.entity.main.CmsWorkflowRecord> getCheckRecords() {
		return checkRecords;
	}

	public void setCheckRecords(
			java.util.Set<com.jeecms.cms.entity.main.CmsWorkflowRecord> checkRecords) {

...
public abstract class BaseContent  implements Serializable {
	...
	private java.util.Set<com.jeecms.cms.entity.main.CmsWorkflowEvent> eventSet;
	...
	public java.util.Set<com.jeecms.cms.entity.main.CmsWorkflowEvent> getEventSet() {
		return eventSet;
	}

	public void setEventSet(
			java.util.Set<com.jeecms.cms.entity.main.CmsWorkflowEvent> eventSet) {

...
public abstract class BaseCmsWorkflow  implements Serializable {
	...
	// collections
	private java.util.List<com.jeecms.cms.entity.main.CmsWorkflowNode> nodes;
	private java.util.Set<com.jeecms.cms.entity.main.CmsWorkflowEvent> events;
	 ...
	 */
	public java.util.List<com.jeecms.cms.entity.main.CmsWorkflowNode> getNodes () {
		return nodes;
	}
	 ...
	 */
	public void setNodes (java.util.List<com.jeecms.cms.entity.main.CmsWorkflowNode> nodes) {
		this.nodes = nodes;
	}
	 ...
	 */
	public java.util.Set<com.jeecms.cms.entity.main.CmsWorkflowEvent> getEvents () {
		return events;
	}
	 ...
	 */
	public void setEvents (java.util.Set<com.jeecms.cms.entity.main.CmsWorkflowEvent> events) {
		this.events = events;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.main.CmsWorkflow)) return false;
		else {
			com.jeecms.cms.entity.main.CmsWorkflow cmsWorkflow = (com.jeecms.cms.entity.main.CmsWorkflow) obj;

...
public class CmsUtils {
	...
	public static final String BBS_USER_KEY = "_bbs_user_key";
	 ...
	 * @return
	 */
	public static BbsUser getBbsUser(HttpServletRequest request) {
		return (BbsUser) request.getAttribute(BBS_USER_KEY);
	}
	 ...
	 * @param user
	 */
	public static void setBbsUser(HttpServletRequest request, BbsUser user) {
		request.setAttribute(BBS_USER_KEY, user);
	}

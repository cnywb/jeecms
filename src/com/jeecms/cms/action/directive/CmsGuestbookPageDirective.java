...
public class CmsGuestbookPageDirective extends AbstractCmsGuestbookDirective {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		String keyword=(params.get("q")==null?"":params.get("q").toString());
		Integer userId=(params.get("userId")==null?null:Integer.parseInt(params.get("userId").toString()));
		Pagination page = cmsGuestbookMng.getPageByKeyword(getSiteId(params),
				getCtgId(params),userId, getRecommend(params), getChecked(params),
				getDesc(params), true, pageNo, count,keyword);

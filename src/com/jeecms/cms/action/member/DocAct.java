...
public class DocAct  extends AbstractContentMemberAct{
	...
	public String save(String title, String author, String description,
		...
		return super.save(title, author, description, txt, tagStr, channelId,modelId, doc, captcha, nextUrl, request, response, model);
	}
	...
	public String update(Integer id, String title, String author,
			...
			HttpServletResponse response, ModelMap model) {
		return super.update(id, title, author, description, txt, tagStr, channelId, doc, nextUrl, request, response, model);
	}

...
public class FrameAct {
	...
	/**积分页面*/
	@RequestMapping("/frame/points_main.do")
	public String PointsMain(ModelMap model) {
		return "frame/points_main";
	}

	@RequestMapping("/frame/points_left.do")
	public String PointsLeft(ModelMap model) {
		return "frame/points_left";
	}

	@RequestMapping("/frame/points_right.do")
	public String PointsRight(ModelMap model) {
		return "frame/points_right";
	}

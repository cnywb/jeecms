...
public class CmsDataBackDaoImpl extends JdbcDaoSupport implements
	...
	private boolean isDateTimeColumn(String tablename,int columnIndex){
		if(StringUtils.isNotBlank(tablename)){
			...
			if(upperTableName.equals("JO_USER")){
				if(columnIndex==5||columnIndex==7||columnIndex==14){
					return true;
				}
			}
			...
			//以下bbs表
			if(upperTableName.equals("ATTACHMENT")){
				if(columnIndex==9){
					return true;
				}
			}
			if(upperTableName.equals("BBS_CONFIG")){
				if(columnIndex==15){
					return true;
				}
			}
			if(upperTableName.equals("BBS_FORUM")){
				if(columnIndex==19){
					return true;
				}
			}
			if(upperTableName.equals("BBS_GRADE")){
				if(columnIndex==6){
					return true;
				}
			}
			if(upperTableName.equals("BBS_LOGIN_LOG")){
				if(columnIndex==3||columnIndex==4){
					return true;
				}
			}
			if(upperTableName.equals("BBS_MAGIC_LOG")){
				if(columnIndex==4){
					return true;
				}
			}
			if(upperTableName.equals("BBS_OPERATION")){
				if(columnIndex==8){
					return true;
				}
			}
			if(upperTableName.equals("BBS_POST")){
				if(columnIndex==7||columnIndex==9){
					return true;
				}
			}
			if(upperTableName.equals("BBS_TOPIC")){
				if(columnIndex==9||columnIndex==10||columnIndex==21){
					return true;
				}
			}
			if(upperTableName.equals("BBS_PRIVATE_MSG")){
				if(columnIndex==6){
					return true;
				}
			}
			if(upperTableName.equals("BBS_REPORT")){
				if(columnIndex==4||columnIndex==7){
					return true;
				}
			}
			if(upperTableName.equals("BBS_REPORT_EXT")){
				if(columnIndex==4){
					return true;
				}
			}
			if(upperTableName.equals("BBS_REPORT_EXT")){
				if(columnIndex==9||columnIndex==10||columnIndex==11||columnIndex==21){
					return true;
				}
			}
			if(upperTableName.equals("BBS_VOTE_RECORD")){
				if(columnIndex==4){
					return true;
				}
			}
			if(upperTableName.equals("JB_MESSAGE")){
				if(columnIndex==6){
					return true;
				}
			}
			if(upperTableName.equals("JB_MESSAGE_REPLY")){
				if(columnIndex==6){
					return true;
				}
			}
			if(upperTableName.equals("JB_USER")){
				if(columnIndex==5||columnIndex==7||columnIndex==12||columnIndex==16||columnIndex==28){
					return true;
				}
			}
			if(upperTableName.equals("JB_USER_EXT")){
				if(columnIndex==5){
					return true;
				}
			}
	...
	private boolean isColbColumn(String tablename,int columnIndex){
		if(StringUtils.isNotBlank(tablename)){
			...
			if(upperTableName.equals("BBS_POST_TEXT")){
				if(columnIndex==3){
					return true;
				}
			}
			...
			if(upperTableName.equals("BBS_PRIVATE_MSG_TEXT")){
				if(columnIndex==2){
					return true;
				}
			}

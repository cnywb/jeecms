...
public class CmsGuestbookMngImpl implements CmsGuestbookMng {
    ...
    /**
     * ping.qi modify 辅助 留言管理 新增search条件
     */
	@Transactional(readOnly = true)
	public Pagination getPageByKeywordForCms(String title,String createTimeMin,String createTimeMax,String member ,Integer siteId,Integer ctgId, Integer ctgIds[],Integer userId, String recommend,
			...
			int pageSize){
		return dao.getPageByKeywordForCms(title, createTimeMin, createTimeMax,member, siteId, ctgId, ctgIds, userId, recommend, checked, desc, cacheable, pageNo, pageSize);
	}
	...
	public Pagination getPageByKeyword(Integer siteId, Integer ctgId,Integer userId, Boolean recommend,
		...
		return dao.getPageByKeyword(siteId, ctgId,userId, recommend, checked, desc, cacheable,

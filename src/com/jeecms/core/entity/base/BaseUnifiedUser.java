...
public abstract class BaseUnifiedUser  implements Serializable {
	...
	private static final long serialVersionUID = -7101300328494697376L;
	...
	private Boolean mobilePhoneAuth;//手机号是否通过验证
	
	private Date mobilePhoneAuthTime;//手机号验证通过时间
	...
	public Boolean getMobilePhoneAuth() {
		return mobilePhoneAuth;
	}

	public void setMobilePhoneAuth(Boolean mobilePhoneAuth) {
		this.mobilePhoneAuth = mobilePhoneAuth;
	}
	...
	/**
	 * @param historyPoint the historyPoint to set
	 */
	...
	/**
	 * @param expiredPoint the expiredPoint to set
	 */
	...
	public Date getMobilePhoneAuthTime() {
		return mobilePhoneAuthTime;
	}

	public void setMobilePhoneAuthTime(Date mobilePhoneAuthTime) {
		this.mobilePhoneAuthTime = mobilePhoneAuthTime;
	}
